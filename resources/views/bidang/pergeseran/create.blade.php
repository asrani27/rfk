    ...
    <div class="col-md-8">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title">RENCANA ANGGARAN PERGESERAN KE {{$uraian->status}}</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="januari_keuangan"
                                        id="januari_keuangan"
                                        value="{{number_format($uraian->p_januari_keuangan, 0, '.', '.')}}" {{$bulan <= 1 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="januari_fisik" id="januari_fisik"
                                        value="{{$uraian->p_januari_fisik}}" {{$bulan <= 1 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="februari_keuangan"
                                        ...
                                        value="{{number_format($uraian->p_februari_keuangan, 0, '.', '.')}}" {{$bulan <= 2 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="februari_fisik" id="februari_fisik"
                                        value="{{$uraian->p_februari_fisik}}" {{$bulan <= 2 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="maret_keuangan" id="maret_keuangan"
                                        value="{{number_format($uraian->p_maret_keuangan, 0, '.', '.')}}" {{$bulan <= 3 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="maret_fisik" id="maret_fisik"
                                        value="{{$uraian->p_maret_fisik}}" {{$bulan <= 3 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="april_keuangan" id="april_keuangan"
                                        value="{{number_format($uraian->p_april_keuangan, 0, '.', '.')}}" {{$bulan <= 4 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="april_fisik" id="april_fisik"
                                        value="{{$uraian->p_april_fisik}}" {{$bulan <= 4 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="mei_keuangan" id="mei_keuangan"
                                        value="{{number_format($uraian->p_mei_keuangan, 0, '.', '.')}}" {{$bulan <= 5 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="mei_fisik" id="mei_fisik"
                                        value="{{$uraian->p_mei_fisik}}" {{$bulan <= 5 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="juni_keuangan" id="juni_keuangan"
                                        value="{{number_format($uraian->p_juni_keuangan, 0, '.', '.')}}" {{$bulan <= 6 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="juni_fisik" id="juni_fisik"
                                        value="{{$uraian->p_juni_fisik}}" {{$bulan <= 6 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="juli_keuangan" id="juli_keuangan"
                                        value="{{number_format($uraian->p_juli_keuangan, 0, '.', '.')}}" {{$bulan <= 7 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="juli_fisik" id="juli_fisik"
                                        value="{{$uraian->p_juli_fisik}}" {{$bulan <= 7 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="agustus_keuangan"
                                        id="agustus_keuangan"
                                        value="{{number_format($uraian->p_agustus_keuangan, 0, '.', '.')}}" {{$bulan <= 8 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="agustus_fisik" id="agustus_fisik"
                                        value="{{$uraian->p_agustus_fisik}}" {{$bulan <= 8 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="september_keuangan"
                                        ...
                                        value="{{number_format($uraian->p_september_keuangan, 0, '.', '.')}}" {{$bulan <= 9 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="september_fisik" id="september_fisik"
                                        value="{{$uraian->p_september_fisik}}" {{$bulan <= 9 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="oktober_keuangan"
                                        id="oktober_keuangan"
                                        value="{{number_format($uraian->p_oktober_keuangan, 0, '.', '.')}}" {{$bulan <= 10 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="oktober_fisik" id="oktober_fisik"
                                        value="{{$uraian->p_oktober_fisik}}" {{$bulan <= 10 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="november_keuangan"
                                        ...
                                        value="{{number_format($uraian->p_november_keuangan, 0, '.', '.')}}" {{$bulan <= 11 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="november_fisik" id="november_fisik"
                                        value="{{$uraian->p_november_fisik}}" {{$bulan <= 11 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="desember_keuangan"
                                        ...
                                        value="{{number_format($uraian->p_desember_keuangan, 0, '.', '.')}}" {{$bulan <= 12 ? 'required':'readonly'}}>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="desember_fisik" id="desember_fisik"
                                        value="{{$uraian->p_desember_fisik}}" {{$bulan <= 12 ? 'required':'readonly'}}>
                                </div>
                            </div>
                        </div>
                    </div>
