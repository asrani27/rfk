    ...
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">TAMBAH URAIAN KEGIATAN</h3>
                <!-- /.card-tools -->
            </div>
            <!-- /.card-header -->
            <form method="post"
                action="/skpd/bidang/program/kegiatan/{{$program_id}}/sub/{{$kegiatan_id}}/uraian/{{$subkegiatan_id}}/add">
                @csrf
                <div class="card-body" style="display: block;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{$subkegiatan->nama}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
