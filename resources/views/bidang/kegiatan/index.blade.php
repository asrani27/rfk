        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="/skpd/bidang/program/kegiatan/{{$program->id}}/add" type="button"
                ...
                <table id="example1" class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr style="font-size: 14px">
                            ...
                            <td>{{$item->nama}}</td>
                            <td>
                                <a href="/skpd/bidang/program/kegiatan/{{$program->id}}/sub/{{$item->id}}"
                            ...
                            <td>
                                <a href="/skpd/bidang/program/kegiatan/{{$program->id}}/edit/{{$item->id}}"
                                    class="btn btn-xs btn-outline-primary" data-toggle="tooltip" data-placement="top"
                                    title="Edit Data"><i class="fas fa-edit"></i></a>
                                <a href="/skpd/bidang/program/kegiatan/{{$program->id}}/delete/{{$item->id}}"
