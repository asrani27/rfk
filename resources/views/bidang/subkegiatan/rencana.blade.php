    ...
    <div class="col-md-8">
        <div class="card card-primary card-outline">
            ...
            <form class="form-horizontal" method="post"
                action="/skpd/bidang/program/kegiatan/{{$program_id}}/sub/{{$kegiatan_id}}/rencana/{{$subkegiatan_id}}">
                @csrf
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="januari_keuangan"
                                        id="januari_keuangan"
                                        value="{{number_format($subkegiatan->januari_keuangan, 0, '.', '.')}}" required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="januari_fisik" id="januari_fisik"
                                        value="{{number_format($subkegiatan->januari_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="februari_keuangan"
                                        ...
                                        value="{{number_format($subkegiatan->februari_keuangan, 0, '.', '.')}}"
                                        required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="februari_fisik" id="februari_fisik"
                                        value="{{number_format($subkegiatan->februari_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="maret_keuangan" id="maret_keuangan"
                                        value="{{number_format($subkegiatan->maret_keuangan, 0, '.', '.')}}" required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="maret_fisik" id="maret_fisik"
                                        value="{{number_format($subkegiatan->maret_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="april_keuangan" id="april_keuangan"
                                        value="{{number_format($subkegiatan->april_keuangan, 0, '.', '.')}}" required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="april_fisik" id="april_fisik"
                                        value="{{number_format($subkegiatan->april_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="mei_keuangan" id="mei_keuangan"
                                        value="{{number_format($subkegiatan->mei_keuangan, 0, '.', '.')}}" required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="mei_fisik" id="mei_fisik"
                                        value="{{number_format($subkegiatan->mei_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="juni_keuangan" id="juni_keuangan"
                                        value="{{number_format($subkegiatan->juni_keuangan, 0, '.', '.')}}" required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="juni_fisik" id="juni_fisik"
                                        value="{{number_format($subkegiatan->juni_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="juli_keuangan" id="juli_keuangan"
                                        value="{{number_format($subkegiatan->juli_keuangan, 0, '.', '.')}}" required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="juli_fisik" id="juli_fisik"
                                        value="{{number_format($subkegiatan->juli_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="agustus_keuangan"
                                        id="agustus_keuangan"
                                        value="{{number_format($subkegiatan->agustus_keuangan, 0, '.', '.')}}" required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="agustus_fisik" id="agustus_fisik"
                                        value="{{number_format($subkegiatan->agustus_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="september_keuangan"
                                        ...
                                        value="{{number_format($subkegiatan->september_keuangan, 0, '.', '.')}}"
                                        required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="september_fisik" id="september_fisik"
                                        value="{{number_format($subkegiatan->september_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="oktober_keuangan"
                                        id="oktober_keuangan"
                                        value="{{number_format($subkegiatan->oktober_keuangan, 0, '.', '.')}}" required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="oktober_fisik" id="oktober_fisik"
                                        value="{{number_format($subkegiatan->oktober_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="november_keuangan"
                                        ...
                                        value="{{number_format($subkegiatan->november_keuangan, 0, '.', '.')}}"
                                        required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="november_fisik" id="november_fisik"
                                        value="{{number_format($subkegiatan->november_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="form-control" name="desember_keuangan"
                                        ...
                                        value="{{number_format($subkegiatan->desember_keuangan, 0, '.', '.')}}"
                                        required>
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control" name="desember_fisik" id="desember_fisik"
                                        value="{{number_format($subkegiatan->desember_fisik, 0, '.', '.')}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
