...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white bg-gradient-primary"
            style="box-shadow: 0 2px 10px 0 #999">
            <div class="container">
                <a href="#" class="navbar-brand">
                    <img src="/admin/bjm.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light text-white"><b>REALISASI FISIK KEUANGAN</b></span>
                </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="text-center">
                                <img src="/admin/bjm.png" alt="AdminLTE Logo" width="100px">
                            </div>
                            <div class="card">
                                <div class="card-body">
