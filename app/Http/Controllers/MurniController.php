...
class MurniController extends Controller
{
    public function create($program_id, $kegiatan_id, $subkegiatan_id, $uraian_id)
    {
        ...
        return view('bidang.murni.create', compact('program', 'kegiatan', 'subkegiatan', 'program_id', 'kegiatan_id', 'subkegiatan_id', 'uraian', 'uraian_id'));
    }
